...
/**
    ...
    * @param refreshToken
    * @returns new access token (type: string)
    * */
function generateNewAccessToken(refreshToken: string) {
...
export { createAccessToken, createRefreshToken, isRefreshTokenExpired, generateNewAccessToken, };
